...
|---|---|
| `scripts/smoke-api.sh <url> <pairing-code>` | Every endpoint: pairing, PIN flows, rate limits, scoped data, LWW, admin 403s, CORS, guests (99 checks) |
