...
const VERSION = 'hub-v17';
const SHELL = [
  './', 'index.html', 'manifest.json', 'icon.svg', 'sw.js',
  'apps/design.css', 'apps/hub.js',
  'apps/f260.html', 'apps/leftovers.html', 'apps/prayer.html', 'apps/tally.html', 'apps/timer.html', 'apps/kidverse.html',
  'icons/f260.svg', 'icons/leftovers.svg', 'icons/prayer.svg', 'icons/tally.svg', 'icons/timer.svg',
  'icons/dollywood.svg', 'icons/dollywood-live.svg', 'icons/kidverse.svg',
